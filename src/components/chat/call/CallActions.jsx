...
import {
  ...
  ScreenShareIcon, // Add a new icon for screen sharing
} from '../../../svg';
    ...
    <div className="h-22 w-full absolute bottom-0 z-40 px-1 openToolsAnimation">
      <div className="relative bg-[#222] px-4 pt-6 pb-12 rounded-xl">
        ...
        <ul className="flex items-center justify-between">
          ...
          >
            <button className={`${togglePictureInPic ? 'bg-green_4' : 'bg-red-400'} btn_secondary`}>
              <PictureInPictureIcon />
            </button>
          </li>
          ...
          >
            <button className={`btn_secondary ${toggleVideo ? 'bg-red-400' : 'bg-green_4'}`}>
          ...
          >
            <button className={`btn_secondary ${toggleAudio ? 'bg-red-400' : 'bg-green_4'}`}>
              <MuteIcon className="fill-white w-7" />
            </button>
          </li>
		  
          <li onClick={handleScreenShare}>
            <button className={`btn_secondary ${handleScreenShare ? 'bg-red-400' : 'bg-green_4'}`}>
              <ScreenShareIcon className="fill-white w-7" />
            </button>
          </li>
